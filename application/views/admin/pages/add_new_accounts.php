<div class = "col-md-12 center-block">
    <div class = "panel panel-default">
        ...
        <div class = "panel-body">
            ...
            <div class = "col-md-11">
                <form id = 'baby_new_accounts' action = "" enctype = "multipart/form-data" method = "post"
                            ...
                            <div class = "seadiv">
                                ...
                                <ul class = "optlist">
                                    ...
                                    foreach ($account_no as $key => $value) {
                                        ?>
                                        <li class = "accno"
                                            onclick = "get_old_balance('<?php echo $value['accountNo']; ?>');"><a
...
<script src = "<?php echo base_url(); ?>assets/js/Custom_Validation/baby_accounts/baby_new_accounts_validation.js"></script>
<script>
