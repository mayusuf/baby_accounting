                        ...
                        <div class = "box-body">
                            <div class = "col-md-12 col-sm-12">
                                ...
                                <table id = "all_baby_accounts" class = "table table-bordered table-hover">
                                    ...
                                    echo "<tbody>";
                                    $i = 0;
                                   foreach ($last_data_records as $key => $value) {


                                        $id = $value['Id'];
                                        $accounts_no = $accounts_table[$i++];
                                        $entryDate = $value['entryDate'];
                                        $deposit = $value['deposit'];
                                        $withDraw = $value['withDraw'];
                                        $balance = $value['balance'];
                                        $edit_url = base_url('admin/baby_accounts/update_transaction/' . $id .'/'.$accounts_no);


                                        echo "<tr>";
                                        echo "<td>" . $serial++ . "</td>";
                                        echo "<td>" . $accounts_no . "</td>";
