<?php foreach ($last_records as $key => $value) {
                ...
                <form id = 'update_transaction' action = "" enctype = "multipart/form-data" method = "post" accept-charset = "utf-8">
                    <div class = "box-body">
                        ...
                        <div class = "col-md-3  form-group">
                            ...
                            <input type = "text" class = "form-control" id = "old_balance" name = "old_balance" value = "<?php echo $balance ?>"
                                   readonly>
                        </div>
                        ...
                        <div class = "col-md-3  form-group new_balance">
                            ...
                            <input type = "text" class = "form-control" id = "new_balance" name = "new_balance" value = "<?php echo $balance ?>"
                                   readonly>
                        </div>
                    </div>
